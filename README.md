...
1 . [کد تمیز در پایتون](https://github.com/SepehrRasouli/clean-code-python) ⭐ 177 | 🐛 0 | 🌐 Python | 📅 2023-03-22 : (1) راهنمای نوشتن کد تمیز در پایتون
...
2 . [جنگو برای API ها](https://github.com/ftg-iran/dfa-persian) ⭐ 216 | 🐛 1 | 🌐 Markdown | 📅 2022-12-27 : ساخت web api ها با پایتون و جنگو

3 . [جنگو برای حرفه‌ای ها](https://github.com/ftg-iran/dfp-persian) ⭐ 23 | 🐛 0 | 🌐 Markdown | 📅 2025-08-02 : ساخت وب سایت با پایتون و جنگو

### جاوااسکریپت

1 . [کد تمیز در جاوااسکریپت](https://github.com/SepehrRasouli/clean-code-python) ⭐ 177 | 🐛 0 | 🌐 Python | 📅 2023-03-22 : راهنمای نوشتن کد تمیز در جاوااسکریپت
...
4 . [یادگیری اصولی جاوااسکریپت](https://github.com/Mariotek/BetterUnderstandingOfJavascript) ⭐ 203 | 🐛 1 | 🌐 HTML | 📅 2023-06-29 : کتاب یادگیری اصولی جاواسکریپت پایه
...
3 . [آموزش دیزاین پترن به زبون آدمیزاد](https://github.com/3lf/design-patterns-for-humans) ⭐ 1,080 | 🐛 0 | 📅 2026-06-27 :  فهمیدن دیزاین پترن‌ها از اون موضوع‌هاست که ذهن رو به چالش میکشه. اینجا سعی می‌کنم با مثال‌های ساده از دنیای واقعی و دنیای کد ، اونو راحت وارد ذهنتون کنم.
